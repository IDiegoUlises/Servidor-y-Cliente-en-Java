...
**Decifrar en un Superordenador:** En **Suiza** existen 2 superordenadores en todo el pais y en todo el planeta estan disponible 495 **superordenadores** repartidos por todo el mundo con una potencia de calculo aproximado a **148 petaflops** que realizan más de 1000 billones de operaciones por segundo es suficiente para romper este cifrado en segundos.
